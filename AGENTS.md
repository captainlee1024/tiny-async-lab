...
- Before drafting or substantially rewriting a learning chapter, record its driving question, causal or concept-dependency path, evidence boundaries, and understanding checks in the active ExecPlan or temporary working notes. This is authoring scaffolding; do not mechanically copy it into reader-facing documentation.
- Treat review-accepted learning chapters as a quality floor for evidence discipline, conceptual completeness, and reader clarity, not as fixed section or length templates. Adapt and improve the structure for each question without omitting applicable reasoning or boundaries.
- CI success does not establish knowledge quality. Do not mark a chapter or roadmap item complete until its technical and teaching reviews pass and the designated human reviewer accepts it; if review rejects it, restore the incomplete state and record the concrete knowledge or structure failure before revising.
